...
var component = ReasonReact.reducerComponent("Star");
  ...
  return /* record */[
          ...
          /* render */(function (self) {
              return ReasonReact.element(/* None */0, /* None */0, Curry._4(AddStarMutation[/* make */4], /* None */0, /* None */0, /* None */0, (function (addMutation, _) {
                                ...
                                var match = self[/* state */1][/* starred */0];
                                return React.createElement("button", {
                                            onClick: (function () {
                                                Curry._1(self[/* send */3], /* AddStar */0);
          ...
          /* initialState */(function () {
              return /* record */[/* starred */viewerHasStarred];
            }),
          /* retainedProps */component[/* retainedProps */11],
          /* reducer */(function (_, _$1) {
              return /* Update */Block.__(0, [/* record */[/* starred */true]]);
            }),
